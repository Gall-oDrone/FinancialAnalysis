...
Usage:
    ...
    python -m DataProcessing.etl_cli transform-news --date 2026-01-27
    python -m DataProcessing.etl_cli export-genai --date 2026-01-27 --output genai.jsonl
"""
...
def export_genai(
    ...
    if include_embeddings:
        from DataProcessing.genai_export import generate_embeddings
...
Examples:
  ...
  python -m DataProcessing.etl_cli ingest-stocks --books btc-usd,eth-usd
  
  # Transform stocks and upload to S3
  python -m DataProcessing.etl_cli transform-stocks --since 2026-01-01 --upload-s3
  
  # Ingest today's news
  python -m DataProcessing.etl_cli ingest-news --date 2026-01-27
  
  # Transform news with specific sentiment backend
  python -m DataProcessing.etl_cli transform-news --sentiment vader
